    ...
    ($func:tt) => {
        mod edge_cases {
            ...
            fn test_root_delegate() {
                let contents =
                    fs::read_to_string("../resources/scripts/edge_cases/root_delegate.nut")
                        .expect("Unable to read script source");
                $func(ROOT_DELEGATE_PATH, &contents);
            }
            const ITERATION_PATH: &str = "edge_cases/iteration.nut";
            #[test]
            fn test_iteration() {
                let contents = fs::read_to_string("../resources/scripts/edge_cases/iteration.nut")
                    .expect("Unable to read script source");
            ...
            #[test]
            fn test_func_env() {
                let contents = fs::read_to_string("../resources/scripts/edge_cases/func_env.nut")
                    .expect("Unable to read script source");
            ...
            #[test]
            fn test_set_scope() {
                let contents = fs::read_to_string("../resources/scripts/edge_cases/set_scope.nut")
                    .expect("Unable to read script source");
            ...
            fn test_overwriting_scope() {
                let contents =
                    fs::read_to_string("../resources/scripts/edge_cases/overwriting_scope.nut")
                        .expect("Unable to read script source");
            ...
            fn test_inherit_env() {
                let contents =
                    fs::read_to_string("../resources/scripts/edge_cases/inherit_env.nut")
                        .expect("Unable to read script source");
            ...
            fn test_class_modify() {
                let contents =
                    fs::read_to_string("../resources/scripts/edge_cases/class_modify.nut")
                        .expect("Unable to read script source");
            ...
            fn test_default_args() {
                let contents =
                    fs::read_to_string("../resources/scripts/edge_cases/default_args.nut")
                        .expect("Unable to read script source");
            ...
            #[test]
            fn test_lost_env() {
                let contents = fs::read_to_string("../resources/scripts/edge_cases/lost_env.nut")
                    .expect("Unable to read script source");
            ...
            fn test_parent_scope() {
                let contents =
                    fs::read_to_string("../resources/scripts/edge_cases/parent_scope.nut")
                        .expect("Unable to read script source");
        ...
        mod parse_test {
            ...
            #[test]
            fn test_newlines() {
                let contents = fs::read_to_string("../resources/scripts/parse_test/newlines.nut")
                    .expect("Unable to read script source");
            ...
            mod lexical_structure {
                ...
                fn test_keywords() {
                    let contents = fs::read_to_string(
                        "../resources/scripts/verify/lexical_structure/keywords.nut",
                    )
                    .expect("Unable to read script source");
                ...
                fn test_literals() {
                    let contents = fs::read_to_string(
                        "../resources/scripts/verify/lexical_structure/literals.nut",
                    )
                    .expect("Unable to read script source");

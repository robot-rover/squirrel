...
OUTPUTS = Path('squirrel_lang/src/vm/runtime/snapshots')
...
def register_script(script):
    ...
    output = OUTPUTS / f'squirrel_lang__vm__runtime__tests__vm-{"-".join(output_name_components)}.snap'
    script_ident = script.relative_to(SCRIPTS)
    print(script_ident)
    with output.open('w') as handle:
        handle.write(dedent(f"""\
            ---
            source: squirrel_lang/src/vm/runtime/mod.rs
